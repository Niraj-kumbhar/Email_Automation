...
range_ = df.shape[0]
fromaddr = "nikhil.kumbhar@somaiya.edu" # change if sender file name is different
...
We hope you liked our session and get to see your further participation for our future events!
 
Kindly stay tuned to our social media accounts, to be updated for our future events!
...
""" 
        ...
        s.starttls()
        s.login(fromaddr, "kunvxtitwbgmzdmw") # Authentication of sender, generated by app password
        text = msg.as_string()
        ...
        print(f'total time taken: {time_}')
