...
range_ = df.shape[0]
sender = "nikhil.kumbhar@somaiya.edu" # change if sender file name is different
...
""" 
        ...
        s.starttls()
        s.login(sender, "kunvxtitwbgmzdmw") # Authentication of sender, generated by app password
        text = msg.as_string()
